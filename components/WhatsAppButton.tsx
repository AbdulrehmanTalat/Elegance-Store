...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 md:bottom-6 right-6 z-[60] flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl transition-all duration-300 hover:scale-110 group"
